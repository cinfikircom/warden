...
const BY_PREFIX: ReadonlyArray<readonly [string, RiskEntry]> = [
  ...
  ["B6-ssrf-node", { cvss: 8.6, exploitability: "high" }],
  ["B6-ssrf-py", { cvss: 8.6, exploitability: "high" }],
  ["B6-ssti-py", { cvss: 9.8, exploitability: "high" }],
  ["B6-ssti-node", { cvss: 8.1, exploitability: "medium" }],
  ["B6-path-traversal-node", { cvss: 7.5, exploitability: "high" }],
  ["B6-path-traversal-py", { cvss: 7.5, exploitability: "high" }],
  ["B6-xxe-py", { cvss: 7.1, exploitability: "medium" }],
  ["B8-deserialize-node", { cvss: 9.8, exploitability: "high" }],
  ["B8-pickle-py", { cvss: 9.8, exploitability: "high" }],
  ["B8-unserialize-php", { cvss: 8.1, exploitability: "medium" }],
  ["B8-dotnet-deserialize", { cvss: 9.8, exploitability: "high" }],
  ["B4-jwt-alg-none", { cvss: 9.8, exploitability: "high" }],
  ["B7-open-redirect", { cvss: 5.4, exploitability: "medium" }],
  ...
  ["B1-provider-token", { cvss: 9.1, exploitability: "high" }],
  ["B1-high-entropy-secret", { cvss: 7.5, exploitability: "medium" }],
  ["B1-history-secret", { cvss: 8.6, exploitability: "high" }],
  ...
  // Frontend (Modül FE) — satır kuralları + pencere kuralları
  ...
  ["FE-svelte-html", { cvss: 6.1, exploitability: "medium" }],
  ["FE-astro-set-html", { cvss: 6.1, exploitability: "medium" }],
  ["FE-innerhtml-sink", { cvss: 6.1, exploitability: "medium" }],
  ["FE-javascript-url", { cvss: 6.1, exploitability: "medium" }],
  ["FE-unsafe-url-binding", { cvss: 4.3, exploitability: "low" }],
  ["FE-postmessage-wildcard", { cvss: 6.5, exploitability: "medium" }],
  ["FE-message-no-origin", { cvss: 6.5, exploitability: "medium" }],
  ["FE-csp-unsafe", { cvss: 5.4, exploitability: "medium" }],
  ["FE-source-map-prod", { cvss: 3.7, exploitability: "low" }],
  ["FE-tabnabbing", { cvss: 3.1, exploitability: "low" }],
  ["FE-sri-missing", { cvss: 5.3, exploitability: "medium" }],
  // Parity
