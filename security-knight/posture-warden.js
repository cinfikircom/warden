...
export const WARDEN_POSTURE = {
  ...
  ranks: RANKS,
  layers: [
    { key:"A", kind:"warden", icon:"🏰", name:"Deployment Bulwark", realName:"Parity & Deployment", weight:10, z:6,
      desc:"Prod drift, destructive migrations, env parity, backups, TLS expiry.", quest:q("Deployment/Parity") },
    { key:"B", kind:"warden", icon:"🗡️", name:"Code Blade", realName:"SAST — code security", weight:18, z:9,
      desc:"Secrets, injection (SQL/SSRF/SSTI…), weak crypto, IDOR, deserialization.", quest:q("Code (SAST)") },
    { key:"D", kind:"warden", icon:"📜", name:"Charter of Law", realName:"Compliance & maturity", weight:10, z:8,
      desc:"Observability, secret management, CI/CD, PCI-DSS, GDPR/KVKK.", quest:q("Compliance") },
    { key:"CLOUD", kind:"warden", icon:"☁️", name:"Sky Ward", realName:"Cloud / IaC", weight:12, z:7,
      desc:"Public buckets, IAM wildcards, open security groups, public DBs (Terraform).", quest:q("Cloud/IaC") },
    { key:"K8S", kind:"warden", icon:"⚓", name:"Fleet Anchor", realName:"Kubernetes", weight:8, z:6,
      desc:"Privileged/root containers, :latest images, plaintext secrets, ingress TLS.", quest:q("Kubernetes") },
    { key:"FE", kind:"warden", icon:"🖥️", name:"Glass Aegis", realName:"Frontend security", weight:7, z:9,
      desc:"XSS sinks, token-in-localStorage, weak CSP, prod source maps.", quest:q("Frontend") },
    { key:"AI", kind:"warden", icon:"🤖", name:"Oracle Ward", realName:"AI / LLM security", weight:7, z:8,
      desc:"Embedded LLM keys, prompt-injection surface, system-prompt leakage.", quest:q("AI/LLM") },
    { key:"C", kind:"warden", icon:"🛡️", name:"Live Rampart", realName:"DAST — live checks", weight:10, z:9,
